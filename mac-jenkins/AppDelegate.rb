...
#  mac-jenkins
#
#  Created by Trent Kocurek on 5/16/11.
...
class AppDelegate
    ...
    #
    # Returns the directory the application uses to store the Core Data store file. This code uses a directory named "mac_jenkins" in the user's Library directory.
    #
    def applicationFilesDirectory
        ...
        library_url.URLByAppendingPathComponent("mac_jenkins")
    end
    ...
    def managedObjectModel
        unless @managedObjectModel
          model_url = NSBundle.mainBundle.URLForResource("mac_jenkins", withExtension:"momd")
    ...
    def persistentStoreCoordinator
        ...
        url = directory.URLByAppendingPathComponent("mac_jenkins.storedata")
